...
{
	int i=0;
	//allocate space for vectos A,B and C
	float alpha = 2.0;
	...
	// Set the arguements of the kernel
	...
	//Process on item at a time
	clStatus = clEnqueueNDRangeKernel(command_queue,kernel,1,NULL,&global_size,&local_size,0,NULL,NULL);

	// Creat the cl memory C_clmem on device to the host variable C
